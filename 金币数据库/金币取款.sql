...
BEGIN
	...
	SELECT @MinSwapScore=StatusValue FROM THAccountsDBLink.THAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'BankPrerequisite'
	...
	-- 银行税收
	SELECT @RevenueRate=StatusValue FROM THAccountsDBLink.THAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'RevenueRateTake'
	-- 税收调整
