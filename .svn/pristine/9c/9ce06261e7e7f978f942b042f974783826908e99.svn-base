...
BEGIN
	...
	IF @EducateGrantScore IS NULL SET @EducateGrantScore=999999
	...
	SELECT @MedalRate AS MedalRate, @RevenueRate AS RevenueRate,@ExchangeRate AS ExchangeRate,@WinExperience AS WinExperience, 
		   @ClientVersion AS ClientVersion, @ServerVersion AS ServerVersion, @EducateGrantScore AS EducateGrantScore
