...
osql -E -i "%rootPath%会员类型.sql"
osql -E -i "%rootPath%签到配置.sql"
osql -E -i "%rootPath%等级配置.sql"
osql -E -i "%rootPath%类型配置.sql"
osql -E -i "%rootPath%背包配置.sql"
osql -E -i "%rootPath%任务配置.sql"
osql -E -i "%rootPath%苹果内购.sql"
osql -E -i "%rootPath%红包配置.sql"
osql -E -i "%rootPath%渠道配置.sql"
...
osql -E  -i "%rootPath%背包服务.sql"
osql -E  -i "%rootPath%标识登录.sql"
osql -E  -i "%rootPath%查询用户.sql"
osql -E  -i "%rootPath%超管服务.sql"
osql -E  -i "%rootPath%道具管理.sql"
osql -E  -i "%rootPath%道具配置.sql"
osql -E  -i "%rootPath%兑换管理.sql"
osql -E  -i "%rootPath%活动服务.sql"
