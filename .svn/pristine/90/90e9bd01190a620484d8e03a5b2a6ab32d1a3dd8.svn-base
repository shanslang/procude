...
BEGIN
	...
	-- 加载比赛
	SELECT a.MatchName,a.MatchType,a.MatchFeetype,a.MatchFee,a.MemberOrder,d.* FROM THGameMatchDBLink.THGameMatchDB.dbo.MatchPublic AS a,
	...
	c.InitialBase,c.InitialScore,c.MinEnterGold,c.PlayCount,c.SwitchTableCount,c.PrecedeTimer FROM THGameMatchDBLink.THGameMatchDB.dbo.MatchLockTime b
	LEFT OUTER JOIN THGameMatchDBLink.THGameMatchDB.dbo.MatchImmediate c  ON  b.MatchID=c.MatchID ) 
	UNION ALL 	
	...
	c.InitialBase,c.InitialScore,c.MinEnterGold,c.PlayCount,c.SwitchTableCount,c.PrecedeTimer FROM THGameMatchDBLink.THGameMatchDB.dbo.MatchLockTime b
	RIGHT OUTER JOIN THGameMatchDBLink.THGameMatchDB.dbo.MatchImmediate c  ON  b.MatchID=c.MatchID )) AS d 
...
BEGIN
	...
	-- 加载报名
	SELECT ServerID,MatchID,MatchNo FROM THGameMatchDBLink.THGameMatchDB.dbo.StreamMatchFeeInfo 
...
BEGIN
	...
	-- 加载奖励
	SELECT * FROM THGameMatchDBLink.THGameMatchDB.dbo.MatchReward 
